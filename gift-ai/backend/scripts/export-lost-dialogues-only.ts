import { buildLostDialoguesDirect } from "../src/integrations/crm/export-lost-dialogues-sheet.js";
...
async function main(): Promise<void> {
  ...
  const result = await buildLostDialoguesDirect(account, cfg.sheetId);
