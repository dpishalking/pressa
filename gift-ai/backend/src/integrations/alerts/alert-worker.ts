...
import { processDueWatches, scanRecentlyLostDeals, scanRecentlyPaidInvoices, scanRecentlySentInvoices, scanUnpaidInvoices, scanUnprocessedLeads } from "./rop-alerts.js";
...
async function tick(): Promise<void> {
  ...
  try {
    ...
    await scanRecentlySentInvoices(cfg);
